...
require_once '../_funciones/funciones.php';
	...
	$mail->Subject = "Envío Correo Solicitud de Usuario";
	$mail->Body = '
<html>
<head>
...
<body>
            <div id="principal" style="height:500px;">
              ...
              <div align="center">
                <p>&nbsp;</p>
                <span class="azul">Envío de correo por solicitud de usuario:</span>
                <p>&nbsp;</p>
                <p>Se ha enviado un correo del Sistema Alarmas TACOA solicitando la creación de usuario con los siguientes datos:</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <div align="left">
